	...
	public void add(Process process) {
		...
		if (!processes.contains(process)) {
			...
			try {
				...
				if(factory.getFactoryType().endsWith("PNAKahnFactory")){
//					 System.out.println("factoryyy: "+factory.getFactoryType());
						DataFlowStrategy strategy = new DataFlowStrategy();
						ProcessThreadImpl thread = new ProcessThreadImpl(
								process, strategy);
						thread.trigger();	
				}else if (factory.getFactoryType().endsWith("PNAMOPFactory")){
//			    	  System.out.println("factoryyy: "+factory.toString() );
...
//			    	  ProcessThreadImpl thread = new ProcessThreadImpl(
//								process, strategy);
//			          Method threadMethod = ProcessThread.class.getMethod("trigger",
//			                                                              new Class[]{});
//			          MetaMethodInvocation threadMessage = new SerializableMethodInvocation(threadMethod,
//			                                                                                new Object[]{});
//			          threadMessage.invoke(process);
////			          threadMessage.invoke(thread);


			          
			          
				}else if (factory.getFactoryType().endsWith("PNACompFactory")){
//			    	  System.out.println("factoryyy: "+factory.toString() );
			          ...
			          computation.invoke(ta,threadMessage);
				}
